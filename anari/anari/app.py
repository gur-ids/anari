            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Strong(
                            "When composing team prioritize players from right side (high expected points) and lower side (cheap)"
                        ),
                    ],
                ),
                html.Div(
                ...
                html.H2(
                    style=center_text_style,
                    children=["Evaluation of our ultimate picker guide"],
                ),
                html.Div(
                    style=center_content_style,
                    children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.Strong(
                            "Evaluation of test data. (PTS=A+G) Therefore linear regressions should look similar."
                        ),
                    ],
                ),
                html.Div(
                ...
                html.Div(
                    ...
                    children=[
                        html.Strong(
                            "Correlation of latest different gathered statistics that were used as explanatory variables but from earlier years."
                        ),
                    ],
                ),
                html.Div(
                ...
                html.Div(
                    ...
                    children=[
                        html.Strong(
                            "Time on ice was found to be easily predictable as well"
                        ),
                    ],
                ),
                html.Div(
                ...
                html.Div(
                    ...
                    children=[
                        html.Strong(
                            "+/- had a strong correlation with team points but because of round-robin system in building teams we weren't able to make it work with linear regression."
                        ),
                    ],
                ),
                html.Div(
...
@app.callback(Output("render_team_stats", "children"), [Input("tabs", "value")])
        ...
        [
                        ...
                        [
                            dcc.Dropdown(
                                ...
                                options=[
                                    ...
                                    for i in tv.dropdown_label_values
                                ],
                                value="+/-",
                            ),
                            dcc.Checklist(
                                ...
                                options=[
                                    {"label": i.get("label"), "value": i.get("value")}
                                    for i in tv.position_label_values
                                ],
                                value=["C", "D", "LW", "RW"],
                            ...
                            dcc.RadioItems(
                                ...
                                options=[
                                    {"label": i.get("label"), "value": i.get("value")}
                                    for i in tv.position_agg_method
                                ],
                                value="mean",
                                labelStyle={"display": "inline-block"},
                            ),
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        children=[html.Div(id="team-details-scatter")],
                        className="six columns",
                    ),
                ],
                className="row",
            ),
            html.H3(style=center_text_style, id="team-name-heading-distribution"),
            html.Div(
                className="container",
                children=[
                    html.Div(
...
def update_detailed_team_graphs(hoverData, player_positions, criteria, other_criteria):
    ...
    team_name_full = (
        hoverData["points"][0]["text"]
        if hoverData is not None
        else "Nashville Predators"
    )
    ...
    top_paid = html.Div(
        children=[
            html.Div(
                style=center_content_style, children=[g.generate_table(top_paid_df)]
            ),
            html.Div(
                style=center_text_style,
                children=[
                    ...
                    html.P(
                        tv.top_paid_max_cap_hit_text(
                            top_paid_cap_hit_total, MAX_CAP_HIT
                        )
                    ),
